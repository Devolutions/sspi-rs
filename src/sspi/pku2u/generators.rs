...
use picky_krb::crypto::diffie_hellman::{generate_private_key, get_default_parameters};
        ...
        body: ExplicitContextTag1::from(Pku2uNegoBody {
            ...
            sname: ExplicitContextTag1::from(PrincipalName {
                ...
                name_string: ExplicitContextTag1::from(Asn1SequenceOf::from(vec![
                    ...
                    // for the debugging
                    KerberosStringAsn1::from(IA5String::from_str("192.168.0.105")?),
                ])),
            }),
        }),
    })
