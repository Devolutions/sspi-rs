...
use crate::sspi::ntlm::{ChallengeMessage, NegotiateFlags, Ntlm, NtlmState};
...
pub fn write_challenge(mut context: &mut Ntlm, mut transport: impl io::Write) -> sspi::Result<SecurityStatus> {
