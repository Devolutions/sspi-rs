    ...
    >
{
    ...
    /// Specifies a mutable reference to a buffer with [OwnedSecurityBuffer] that contains the output buffer descriptor.
    ...
    /// Specifies a mutable reference to an [OwnedSecurityBuffer] generated by a client call to `initialize_security_context`.
