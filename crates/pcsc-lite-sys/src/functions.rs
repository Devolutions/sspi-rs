...
pub type SCardReleaseContextFn = unsafe fn(h_context: ScardContext) -> ScardStatus;

/// Establishes a connection to the reader specified in * szReader.
///
/// [SCardConnect](https://pcsclite.apdu.fr/api/group__API.html#ga4e515829752e0a8dbc4d630696a8d6a5)
pub type SCardConnectFn = unsafe fn(
...
pub type SCardReconnectFn = unsafe fn(
    h_card: ScardHandle,
    dw_share_mode: Dword,
    dw_preferred_protocols: Dword,
...
pub type SCardDisconnectFn = unsafe fn(h_card: ScardHandle, dw_disposition: Dword) -> ScardStatus;
...
pub type SCardBeginTransactionFn = unsafe fn(h_card: ScardHandle) -> ScardStatus;
...
pub type SCardEndTransactionFn = unsafe fn(h_card: ScardHandle, dw_disposition: Dword) -> ScardStatus;

/// Returns the current status of the reader connected to by hCard.
///
/// [SCardStatus](https://pcsclite.apdu.fr/api/group__API.html#gae49c3c894ad7ac12a5b896bde70d0382)
pub type SCardStatusFn = unsafe fn(
    h_card: ScardHandle,
...
pub type SCardGetStatusChangeFn = unsafe fn(
    h_context: ScardContext,
    dw_timeout: Dword,
...
pub type SCardControlFn = unsafe fn(
    h_card: ScardHandle,
...
pub type SCardGetAttribFn =
    unsafe fn(h_card: ScardHandle, dw_attr_id: Dword, pb_attr: LpByte, pcb_atr_len: LpDword) -> ScardStatus;
...
pub type SCardSetAttribFn =
    unsafe fn(h_card: ScardHandle, dw_attr_id: Dword, pb_attr: LpCByte, cb_attr_len: Dword) -> ScardStatus;

/// Sends an APDU to the smart card contained in the reader connected to by `SCardConnect()`.
///
/// [SCardTransmit](https://pcsclite.apdu.fr/api/group__API.html#ga9a2d77242a271310269065e64633ab99)
pub type SCardTransmitFn = unsafe fn(
    h_card: ScardHandle,
...
pub type SCardListReadersFn =
    unsafe fn(h_context: ScardContext, msz_groups: LpCStr, msc_reader: LpStr, pcch_readers: LpDword) -> ScardStatus;
...
pub type SCardFreeMemoryFn = unsafe fn(h_context: ScardContext, pv_mem: LpCVoid) -> ScardStatus;
...
pub type SCardListReaderGroupsFn =
    unsafe fn(h_context: ScardContext, msz_groups: LpStr, pcch_groups: LpDword) -> ScardStatus;
...
pub type SCardCancelFn = unsafe fn(h_context: ScardContext) -> ScardStatus;
...
pub type SCardIsValidContextFn = unsafe fn(h_context: ScardContext) -> ScardStatus;
