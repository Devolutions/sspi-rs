...
use crate::sec_handle::{
    ...
    InitializeSecurityContextFnW, InitializeSecurityContextW, QueryContextAttributesA, QueryContextAttributesExA,
    QueryContextAttributesExFnA, QueryContextAttributesExFnW, QueryContextAttributesExW, QueryContextAttributesFnA,
    QueryContextAttributesFnW, QueryContextAttributesW, QueryCredentialsAttributesA, QueryCredentialsAttributesExA,
